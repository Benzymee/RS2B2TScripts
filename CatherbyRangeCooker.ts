...
function readPrefStr(key: string, fallback: any) {
...
function isKnownRaw(name: string | undefined) {
    return rawFishKind(name) !== null;
}

function isCookedFish(name: string | undefined) {
    if (!name) {
        return false;
    }
...
function canCookKind(kind: string | null | undefined) {
...
function optionToKind(option: string) {
    switch (option) {
...
function normalizeFishOption(raw: unknown) {
...
function isModeRaw(name: string | undefined, mode: string) {
    if (!canCookRaw(name)) {
        return false;
    }
...
function cookableCount(mode: string) {
...
function lastCookableRaw(mode: string) {
...
function countCookableNamed(fragment: any, mode: string) {
...
function matchCookProduct(products: any, preferName: any, mode: string) {
...
function bankCookableCount(mode: string) {
    return bankItemCount(n => isModeRaw(n, mode));
}

function bankFindRawName(kind: string | null | undefined) {
...
function nextWithdrawKind(mode: string) {
    if (mode === FISH_OPTION_EVERYTHING) {
