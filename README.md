...
**ProgressiveChopper** (`ProgressiveChopper.js`). Chops Falador trees, then oaks, willows, Seers maples, and Falador yews as woodcutting and fletching unlock each camp. Optional fletching into bows: yew shortbows (u) at 65 and longbows (u) at 70, banked at Falador east. Picks up the Lumbridge knife if needed. Keeps the best usable axe even if Attack is too low to wield. After buying a Steel axe from Bob, drops the Bronze axe and leftover coins.
